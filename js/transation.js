            ...
            a('.pt-page').each(function() {
                ...
                if (location.hash) {
                    ...
                    s = a(s.parentNode), s.addClass('active'), e(r), a('.pt-wrapper').animate({
                        scrollTop: 0
                    }, 300), a('#page-ajax-loaded').addClass('fadeOutLeft'), a('#page-ajax-loaded > div').detach()
                }
            };
            var m = l.menu,
                n = d();
...
//            a('#page').append('<div id="page-ajax-loaded" class="page-ajax-loaded animated fadeInLeft"></div>'), a(document).on('click', '#portfolio-close-button', function() {
